...
export const listsSlice = createSlice({
    ...
    reducers: {
        ...
        deleteUser(state, action) {
            ...
            // console.log(state.lists[action.payload.indexList].cards[action.payload.indexList].usersCard.splice(0, 1))
            
            state.lists[action.payload.indexList].cards[action.payload.indexCard].usersCard = state.lists[action.payload.indexList].cards[action.payload.indexCard].usersCard.filter((elem) => {return elem !== action.payload.id})
        }
    },
})
